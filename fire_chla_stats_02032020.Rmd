...
fvfm_sigma <- ggplot(dat1, aes(x= Sigma, y = FvFm, color = Temp, shape = Ironconc)) +
  theme_bw() +
  theme(axis.text.x = element_text(angle=45, vjust=1, hjust=1)) +
  geom_point(size=4.9) +
  facet_wrap(~species, scales = "fixed") +
  theme(strip.text = element_text(size=10, face = "bold.italic",margin = margin(.1, .1, .1, .1, "cm"))) +
...
#fvfm_sigma
#save_plot("~/Desktop/PhD/chapters/chapter 4 - temp treatments/for_coauthors_v1/figs/figs_v4_01212020/Fig5_fvfm_sigma.pdf", fvfm_sigma, base_aspect_ratio = 1.6)

######## remake this figure. put Both species in same panel. facet by temperature. make B&W
...
# make a plot
 # box plot
chla <- ggplot(data=all, aes(x=Temp, y=Chlorophyll_A_CELL, fill=Temp, color=Temp)) +
  geom_boxplot(alpha = 0.5, aes(colour = factor(Temp)), varwidth = FALSE, position = position_dodge(1, preserve = "single")) +
  theme_bw() +
  labs(y="ug/L per um3/cell", x="Temperature (°C)", title = "Chlorophyll a content") +
...
chla
save_plot("~/Desktop/PhD/chapters/chapter 4 - temp treatments/for_coauthors_v1/figs/figs_v5_02042020/FigS2_chla.pdf", chla ,base_aspect_ratio = 1.6)
